...
set solution_dir "C:/Users/Vincent/Desktop/cnn-on-pynq-z2/hls_proj_v2/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {conv2d_fadd_32ns_bkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 input_size W 0x0 "Data signal of input_size" {{0 32 input_size W 0 "Bit 31 to 0 Data signal of input_size"}}} {0x18 input_number W 0x0 "Data signal of input_number" {{0 32 input_number W 0 "Bit 31 to 0 Data signal of input_number"}}} {0x20 filter_number W 0x0 "Data signal of filter_number" {{0 32 filter_number W 0 "Bit 31 to 0 Data signal of filter_number"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS stream_filter stream_input stream_output"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
