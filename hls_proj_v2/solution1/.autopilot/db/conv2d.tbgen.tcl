...
set C_modelArgList {
	{ stream_filter_V_data float 32 regular {axi_s 0 volatile  { stream_filter Data } }  }
	{ stream_filter_V_last int 1 regular {axi_s 0 volatile  { stream_filter Last } }  }
	...
	{ input_number int 32 regular {axi_slave 0}  }
	{ filter_number int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stream_filter_V_data", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "stream_filter.V.data","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "stream_filter_V_last", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "stream_filter.V.last","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "input_size", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input_size","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "input_number", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input_number","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "filter_number", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "filter_number","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
# RTL Port declarations: 
set portNum 31
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst_n sc_in sc_logic 1 reset -1 active_low_sync } 
	{ stream_filter_TDATA sc_in sc_lv 32 signal 0 } 
	{ stream_filter_TVALID sc_in sc_logic 1 invld 1 } 
	{ stream_filter_TREADY sc_out sc_logic 1 inacc 1 } 
	{ stream_filter_TLAST sc_in sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"input_size","role":"data","value":"16"},{"name":"input_number","role":"data","value":"24"},{"name":"filter_number","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_AXILiteS_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "AXILiteS", "role": "BRESP" } }, 
 	...
 	{ "name": "stream_filter_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "stream_filter_V_data", "role": "default" }} , 
 	{ "name": "stream_filter_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "stream_filter_V_last", "role": "default" }} , 
 	{ "name": "stream_filter_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "stream_filter_V_last", "role": "default" }} , 
 	{ "name": "stream_filter_TLAST", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_filter_V_last", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "stream_filter_V_data", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "stream_filter_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "stream_filter_V_last", "Type" : "Axis", "Direction" : "I"},
			...
			{"Name" : "input_number", "Type" : "None", "Direction" : "I"},
			{"Name" : "filter_number", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv2d_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_0_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filter_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv2d_fadd_32ns_bkb_U1", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv2d_fmul_32ns_cud_U2", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_stream_output_V_data_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_w1_stream_output_V_last_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	conv2d {
		stream_filter_V_data {Type I LastRead 4 FirstWrite -1}
		stream_filter_V_last {Type I LastRead 4 FirstWrite -1}
		stream_input_V_data {Type I LastRead 5 FirstWrite -1}
		stream_input_V_last {Type I LastRead 5 FirstWrite -1}
		stream_output_V_data {Type O LastRead -1 FirstWrite 7}
		stream_output_V_last {Type O LastRead -1 FirstWrite 7}
		input_size {Type I LastRead 0 FirstWrite -1}
		input_number {Type I LastRead 0 FirstWrite -1}
		filter_number {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	stream_filter_V_data { axis {  { stream_filter_TDATA in_data 0 32 } } }
	stream_filter_V_last { axis {  { stream_filter_TVALID in_vld 0 1 }  { stream_filter_TREADY in_acc 1 1 }  { stream_filter_TLAST in_data 0 1 } } }
