...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("stream_filter_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("stream_filter_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("stream_filter_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("stream_filter_TLAST", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("stream_input_TDATA", 32, hls_in, 2, "axis", "in_data", 1),
	Port_Property("stream_input_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("stream_input_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("stream_input_TLAST", 1, hls_in, 3, "axis", "in_data", 1),
	Port_Property("stream_output_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("stream_output_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("stream_output_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
	Port_Property("stream_output_TLAST", 1, hls_out, 5, "axis", "out_data", 1),
