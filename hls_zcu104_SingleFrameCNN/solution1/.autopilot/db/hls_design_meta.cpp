...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("stream_kernel_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("stream_kernel_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("stream_kernel_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("stream_kernel_TLAST", 1, hls_in, 1, "axis", "in_data", 1),
