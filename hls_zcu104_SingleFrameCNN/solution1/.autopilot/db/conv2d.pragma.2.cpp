...
# 1 "src_code_v3/conv2d.h" 2
# 10 "src_code_v3/conv2d.h"
struct AXI_T {
 float data;
 bool last;
};
...
_ssdm_op_SpecInterface(&stream_kernel, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
...
_ssdm_op_SpecInterface(input_row, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(input_col, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
