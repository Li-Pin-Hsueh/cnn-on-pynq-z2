...
(* CORE_GENERATION_INFO="conv2d,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.419000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=16,HLS_SYN_DSP=5,HLS_SYN_FF=1316,HLS_SYN_LUT=1654,HLS_VERSION=2020_1}" *)
...
wire  signed [63:0] sext_ln84_fu_755_p1;
...
wire   [31:0] zext_ln76_fu_671_p1;
wire   [6:0] trunc_ln84_fu_691_p1;
wire   [11:0] trunc_ln84_1_fu_703_p1;
wire   [12:0] zext_ln84_cast_fu_695_p3;
wire   [12:0] zext_ln84_2_cast_fu_707_p3;
wire   [31:0] zext_ln77_fu_721_p1;
wire   [0:0] icmp_ln79_1_fu_736_p2;
wire   [12:0] trunc_ln84_2_fu_746_p1;
wire   [12:0] add_ln84_fu_750_p2;
reg   [19:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln76_fu_675_p2 == 1'd1) & (regslice_both_stream_output_V_data_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state17))) begin
        col_3_reg_316 <= 31'd0;
    end else if (((stream_output_TREADY_int == 1'b1) & (1'b1 == ap_CS_fsm_state20))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln77_fu_725_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state18))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln76_fu_675_p2 == 1'd1) & (regslice_both_stream_output_V_data_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state17))) begin
        ...
        sub_ln84_reg_939[12 : 1] <= sub_ln84_fu_715_p2[12 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln58_fu_540_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state7))) begin
        output_addr_reg_865 <= sext_ln60_fu_560_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((regslice_both_stream_output_V_data_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state17))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln63_fu_565_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        sext_ln65_cast_reg_878[13 : 6] <= sext_ln65_cast_fu_591_p3[13 : 6];
...
always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_485_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
        sub_ln60_reg_842[12 : 1] <= sub_ln60_fu_520_p2[12 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln77_fu_725_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state18))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln40_fu_410_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        zext_ln43_cast_reg_806[13 : 6] <= zext_ln43_cast_fu_425_p3[13 : 6];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (~((icmp_ln29_fu_371_p2 == 1'd0) & (stream_kernel_TVALID_int == 1'b0)) & (1'b1 == ap_CS_fsm_state3)))) begin
        kernel_ce0 = 1'b1;
    end else begin
        kernel_ce0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state18)) begin
        output_address0 = sext_ln84_fu_755_p1;
    end else if ((1'b1 == ap_CS_fsm_state16)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state18) | (1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state7))) begin
        output_ce0 = 1'b1;
    end else begin
        output_ce0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state16) | ((icmp_ln58_fu_540_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state7)))) begin
        output_we0 = 1'b1;
    end else begin
        output_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((stream_output_TREADY_int == 1'b1) & (1'b1 == ap_CS_fsm_state19))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state17 : begin
            if (((icmp_ln76_fu_675_p2 == 1'd0) & (regslice_both_stream_output_V_data_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state17))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((icmp_ln76_fu_675_p2 == 1'd1) & (regslice_both_stream_output_V_data_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state17))) begin
        ...
        ap_ST_fsm_state20 : begin
            if (((stream_output_TREADY_int == 1'b1) & (1'b1 == ap_CS_fsm_state20))) begin
                ap_NS_fsm = ap_ST_fsm_state18;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state20;
            end
...
assign add_ln31_fu_396_p2 = (sub_ln31_reg_782 + zext_ln31_2_fu_392_p1);

assign add_ln43_fu_471_p2 = (zext_ln43_cast_reg_806 + trunc_ln43_fu_467_p1);

assign add_ln60_fu_555_p2 = (sub_ln60_reg_842 + trunc_ln60_2_fu_551_p1);

assign add_ln65_1_fu_641_p2 = (trunc_ln65_1_fu_637_p1 + zext_ln65_3_fu_633_p1);

assign add_ln65_2_fu_647_p2 = (add_ln65_1_fu_641_p2 + sext_ln65_cast_reg_878);

assign add_ln65_3_fu_661_p2 = (zext_ln65_4_fu_657_p1 + sub_ln65_reg_883);

assign add_ln65_fu_585_p2 = (trunc_ln65_fu_581_p1 + zext_ln65_fu_577_p1);

assign add_ln79_1_fu_531_p2 = ($signed(input_col_read_reg_760) + $signed(32'd4294967293));

assign add_ln79_fu_526_p2 = ($signed(input_row_read_reg_767) + $signed(32'd4294967293));

assign add_ln84_fu_750_p2 = (sub_ln84_reg_939 + trunc_ln84_2_fu_746_p1);
...
assign col_6_fu_730_p2 = (col_3_reg_316 + 31'd1);

assign col_boundary_fu_438_p2 = ($signed(input_col_read_reg_760) + $signed(32'd4294967294));
...
assign icmp_ln40_fu_410_p2 = (($signed(zext_ln40_fu_406_p1) < $signed(input_row_read_reg_767)) ? 1'b1 : 1'b0);

assign icmp_ln41_fu_447_p2 = (($signed(zext_ln41_fu_443_p1) < $signed(input_col_read_reg_760)) ? 1'b1 : 1'b0);

assign icmp_ln57_fu_485_p2 = (($signed(zext_ln57_fu_481_p1) < $signed(row_boundary_reg_811)) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_540_p2 = (($signed(zext_ln58_fu_536_p1) < $signed(col_boundary_reg_817)) ? 1'b1 : 1'b0);

assign icmp_ln63_fu_565_p2 = ((m_0_reg_271 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln64_fu_621_p2 = ((n_0_reg_294 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln76_fu_675_p2 = (($signed(zext_ln76_fu_671_p1) < $signed(row_boundary_reg_811)) ? 1'b1 : 1'b0);

assign icmp_ln77_fu_725_p2 = (($signed(zext_ln77_fu_721_p1) < $signed(col_boundary_reg_817)) ? 1'b1 : 1'b0);

assign icmp_ln79_1_fu_736_p2 = ((zext_ln77_fu_721_p1 == add_ln79_1_reg_852) ? 1'b1 : 1'b0);

assign icmp_ln79_fu_686_p2 = ((zext_ln76_fu_671_p1 == add_ln79_reg_847) ? 1'b1 : 1'b0);
...
assign row_6_fu_680_p2 = (row_3_reg_305 + 31'd1);

assign row_boundary_fu_433_p2 = ($signed(input_row_read_reg_767) + $signed(32'd4294967294));
...
assign sext_ln65_1_fu_666_p1 = $signed(add_ln65_3_fu_661_p2);

assign sext_ln65_cast_fu_591_p3 = {{add_ln65_fu_585_p2}, {6'd0}};

assign sext_ln65_fu_652_p1 = $signed(add_ln65_2_fu_647_p2);

assign sext_ln84_fu_755_p1 = $signed(add_ln84_fu_750_p2);

assign stream_output_TLAST_int = tmp_last_reg_952;
...
assign sub_ln84_fu_715_p2 = (zext_ln84_cast_fu_695_p3 - zext_ln84_2_cast_fu_707_p3);
...
assign tmp_last_fu_741_p2 = (icmp_ln79_reg_934 & icmp_ln79_1_fu_736_p2);
...
assign trunc_ln84_1_fu_703_p1 = row_3_reg_305[11:0];

assign trunc_ln84_2_fu_746_p1 = col_3_reg_316[12:0];

assign trunc_ln84_fu_691_p1 = row_3_reg_305[6:0];
...
assign zext_ln76_fu_671_p1 = row_3_reg_305;

assign zext_ln77_fu_721_p1 = col_3_reg_316;

assign zext_ln84_2_cast_fu_707_p3 = {{trunc_ln84_1_fu_703_p1}, {1'd0}};

assign zext_ln84_cast_fu_695_p3 = {{trunc_ln84_fu_691_p1}, {6'd0}};

always @ (posedge ap_clk) begin
    zext_ln43_cast_reg_806[5:0] <= 6'b000000;
    sub_ln60_reg_842[0] <= 1'b0;
    sext_ln65_cast_reg_878[5:0] <= 6'b000000;
    sub_ln84_reg_939[0] <= 1'b0;
end
